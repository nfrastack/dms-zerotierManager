...
PluginComponent {
    ...
    // Break glass - clear all in-flight markers after 4s if something stalls
    Timer {
        id: inFlightTimer
        interval: 4000
        repeat: false
            ...
            Column {
                ...
                StyledText {
                    ...
                    text: root.zerotierAvailable
                        ? "No ZeroTier networks. Add one in plugin Settings -> Configured networks, or run `zerotier-cli join <network-id>` from shell."
                        : "ZeroTier daemon unreachable. Make sure zerotier-one is running and that '" + root.zerotierBinary + "' is on PATH."
